...
namespace MyBolg.ToolKits.Extensions
{
    public static class EncryptExtensions
    {
        ...
        {
            if (inputStr.IsNull()) return null;
        ...
        {
            if (base64String.IsNull()) return null;
        ...
        {
            if (inputStr.IsNullOrEmpty()) return inputStr;
        ...
        /// <returns></returns>
        public static string EncodSha1String(this string inputStr)
        {
            if (inputStr.IsNull()) return null;
